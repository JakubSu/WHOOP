...
export function LoginPage() {
  ...
  return (
    ...
    >
      <div className="relative mb-6 overflow-hidden rounded-xl border border-primary/30 bg-accent/45 p-4 text-left shadow-sm">
        <div
          className="pointer-events-none absolute -right-8 -top-10 size-28 rounded-full bg-primary/10"
          aria-hidden="true"
        />
        ...
        <Button
          className="relative mt-4 w-full shadow-sm"
          type="button"
        ...
        <InlineError
          message={demo.error ? getErrorMessage(demo.error) : null}
        />
      </div>
