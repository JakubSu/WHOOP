...
export function CoachOverlay() {
  ...
  return <div className="contents" aria-live={chat.isStreaming ? 'polite' : 'off'}>
    ...
    {isDesktop ? <aside className="relative min-h-0 border-l border-border bg-card" data-tour="coach-panel">
      {desktop.mode === 'collapsed' ? <Button className="m-1 size-10" variant="ghost" size="icon" type="button" aria-label="Open coach" onClick={openCoach} data-tour="coach-open"><Sparkles size={19} aria-hidden="true" /></Button> : null}
