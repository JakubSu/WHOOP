          ...
          {weekDays.map((day) => (
            <section key={day.date}>
              ...
              <div className="grid gap-2">
                {day.workouts.length ? day.workouts.map((workout) => <WorkoutListItemButton key={workout.id} workout={workout} compact={compact} isTourWorkout={!compact && workout.date === date} />) : (
