...
class RecommendationSerializer(serializers.Serializer):
    ...
    source = serializers.CharField(read_only=True, help_text="Recommendation source such as daily_recommendation or coach_chat.")
    coach_conversation_id = serializers.UUIDField(read_only=True, allow_null=True, help_text="Coach conversation that created this recommendation, when applicable.")
    coach_message_id = serializers.UUIDField(read_only=True, allow_null=True, help_text="Coach assistant message that created this recommendation, when applicable.")
