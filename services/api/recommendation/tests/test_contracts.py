...
from recommendation.contracts import AddExercisePayload, RecommendationDraft


class RecommendationContractTests(SimpleTestCase):
    def test_add_exercise_accepts_existing_workout_repetition_prescription(self) -> None:
