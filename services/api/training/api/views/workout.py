...
class WorkoutCollectionAPIView(APIView):
    ...
    def get(self, request: Request) -> Response:
        workouts = services.list_workouts()
    ...
    def post(self, request: Request) -> Response:
        ...
        try:
            workout = services.create_workout(validated_data_as_dict(serializer))
...
class WorkoutDetailAPIView(APIView):
    ...
    def get(self, request: Request, pk: str) -> Response:
        workout = services.get_workout(pk)
        if workout is None:
            raise NotFound()
    ...
    def patch(self, request: Request, pk: str) -> Response:
        ...
        serializer.is_valid(raise_exception=True)
        try:
            updated = services.update_workout(workout, validated_data_as_dict(serializer))
        except ValueError as exc:
            raise ValidationError({"detail": str(exc)}) from exc
